...
public class DoiMatKhauDiaLog extends javax.swing.JDialog {
    ...
    public DoiMatKhauDiaLog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        More.jdialogAdd(this, "THAY ĐỔI MẬT KHẨU");
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCurrentPass, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(!currentPass.equals(Auth.user.getMatKhau())) {
            MessDiaLogHelper.showMessDiaLog(this, "Sai Pasword", "Sai ");
            
        } else if(!newPass.equals(confirmPass)) {
            MessDiaLogHelper.showMessDiaLog(this, "Mật khẩu xác nhận không trùng khớp", "Sai ");
        } else{
            try {
                Auth.user.setMatKhau(newPass);
                dao.update(Auth.user);
                MessDiaLogHelper.showMessDiaLog(this, "Đổi mật khẩu thành công", "Thông báo");
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
